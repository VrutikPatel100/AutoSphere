                            ...
                            <table class="table table-bordered table-hover" id="myTable">
                                ...
                                <tbody>
                                    <c:forEach items="${allCarFeatures}" var="f">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="deleteCarFeatures?featureId=${f.featureId}" class="btn btn-danger"
                                    ...
                                    <c:if test="${empty allCarFeatures}">
                                        <tr>
                                            <td colspan="7" class="text-center">No car features found</td>
                                        </tr>
                                    </c:if>
						...
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<h2 style="text-align: center;">List Car Features</h2>
								</div>
							</div>
						</div>
					</div>
