                            ...
                            <table class="table table-bordered table-hover" id="myTable">
                                ...
                                <tbody>
                                    <c:forEach items="${allCarVariant}" var="v">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="editCarVariant?variantId=${v.variantId}" class="btn btn-primary">EDIT</a>
                                    ...
                                    <c:if test="${empty allCarVariant}">
                                        <tr>
                                            <td colspan="10" class="text-center">No car variants found</td>
                                        </tr>
                                    </c:if>
