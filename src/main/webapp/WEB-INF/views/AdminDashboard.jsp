							...
							<div class="row">
								...
								<div class="col-md-3 mb-4 stretch-card transparent">
									<div class="card card-light-blue">
										<div class="card-body">
											<p class="mb-4">Total Active Cars</p>
											<p class="fs-30 mb-2">${totalAvailable}</p>
								...
								<div class="col-md-3  mb-4 stretch-card transparent">
									<div class="card card-light-danger">
										<div class="card-body">
											<p class="mb-4">Total Transactions Completed</p>
											<p class="fs-30 mb-2">${totalTransaction}</p>
								...
								<div class="col-md-3 mb-4 stretch-card transparent">
									<div class="card card-tale">
										<div class="card-body">
											<p class="mb-4">Total Offers Made</p>
											<p class="fs-30 mb-2">${totalOffer}</p>
