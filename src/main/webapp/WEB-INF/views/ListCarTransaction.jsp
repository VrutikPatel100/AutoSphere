...
<title>List Car Transactions</title>
                                ...
                                <tbody>
                                    <c:forEach var="t" items="${allTransaction}">
                                        <tr>
                                            ...
                                            <td>${t.completedAt}</td>
                                            <td>
                                                <a href="viewCarTransaction?transactionId=${t.transactionId}" class="btn btn-primary btn-sm mb-1">View</a>
                                                <a href="editCarTransaction?transactionId=${t.transactionId}" class="btn btn-primary btn-sm mb-1">Edit</a>
                                                <a href="deleteTransaction?transactionId=${t.transactionId}" class="btn btn-danger btn-sm mb-1" onclick="return confirm('Are you sure?')">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
						...
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<h2 style="text-align: center;">List Car Transaction</h2>
								</div>
							</div>
						</div>
					</div>
