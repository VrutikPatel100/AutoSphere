                                ...
                                <tbody>
                                    <c:forEach items="${carReports}" var="r">
                                        <tr>
                                            ...
                                            <td>${r.createdAt}</td>
                                            <td>
                                                <a href="viewCarReports?reportId=${r.reportId}" class="btn btn-primary btn-sm mb-1">View</a>
                                                <a href="editCarReports?reportId=${r.reportId}" class="btn btn-primary btn-sm mb-1">Edit</a>
                                                <a href="deleteCarReports?reportId=${r.reportId}" class="btn btn-danger btn-sm mb-1" onclick="return confirm('Are you sure you want to delete this report?')">Delete</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    <c:if test="${empty carReports}">
                                        <tr>
                                            <td colspan="7" class="text-center">No car reports found</td>
                                        </tr>
                                    </c:if>
                                </tbody>
                            </table>
